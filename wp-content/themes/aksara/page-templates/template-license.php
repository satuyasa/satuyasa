 ...
 *
 * Presentasi publik lisensi HiveGlyph. Template ini hanya menampilkan
 * ketentuan; ia tidak membuat, mengubah, atau menggantikan data lisensi
 * pada Authentype / WooCommerce.
 *
 * @package Aksara
 */
...
<main class="license-page">
	<section class="license-page__hero">
		...
		<div class="license-page__meta"><span>HiveGlyph</span><span aria-hidden="true">/</span><span>Issued by HiveGlyph</span><span aria-hidden="true">/</span><span>Type Foundry: Ekayasa</span></div>
	</section>
		...
		<div class="license-page__items">
			<?php foreach ( $licenses as $license ) : ?>
				<article class="license-page-item">
					...
					<div class="license-page-item__body"><div class="license-page__overview"><?php echo esc_html( $license['overview'] ); ?></div><div class="license-page__detail-grid"><div><h4><?php esc_html_e( 'Allowed Uses', 'aksara' ); ?></h4><?php aksara_license_bullets( $license['allowed'] ); ?></div><div><h4><?php esc_html_e( 'Prohibited Uses', 'aksara' ); ?></h4><?php aksara_license_bullets( $license['prohibited'] ); ?></div><div><h4><?php esc_html_e( 'Limitations', 'aksara' ); ?></h4><p><?php echo esc_html( $license['limitations'] ); ?></p></div></div></div>
				</article>
			<?php endforeach; ?>
		</div>
	</section>

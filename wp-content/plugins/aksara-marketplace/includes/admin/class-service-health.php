...
class Aksara_Service_Health {
	 ...
	 * .htaccess — jadi di stack Nginx (yang sangat umum) berkas font
	 * berbayar bisa diunduh siapa saja yang menebak URL-nya, tanpa membeli,
	 * dan tidak ada satu pun gejala yang terlihat dari dalam WordPress.
	 * Kondisi paling merusak yang mungkin terjadi di sistem ini sekaligus
	 * yang paling sunyi.
	 *
	 * Karena itu tidak cukup mendokumentasikannya (komentar di
	 * class-file-storage.php sudah menyebutnya sejak awal, dan itu tidak
	 * menolong siapa pun): di sini kondisinya benar-benar DIUJI. Sebuah
	 * berkas umpan berisi teks yang sudah diketahui — bukan rahasia apa pun
	 * — ditulis ke folder itu, lalu diambil lewat URL publiknya. Kalau
	 * isinya kembali, folder itu memang terbuka.
	 *
